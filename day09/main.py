...
def main():
    ...
    int_code_part1 = IntCode(numbers, 1, 0)
    print("outputs part1:", int_code_part1.outputs)

    int_code_part2 = IntCode(numbers, 2, 0)
    print("outputs part2:", int_code_part2.outputs)
